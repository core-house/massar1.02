    ...
    <ul class="nav nav-tabs mb-3" role="tablist">
        ...
        <li class="nav-item" role="presentation">
            <button class="nav-link font-family-cairo fw-bold"
                    ...
                    type="button">
                <i class="fas fa-chart-line me-2"></i><?php echo e(__('الحسابات')); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                ...
                                <div class="col-12">
                                    ...
                                    <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['late_hour_calculation'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                ...
                                <div class="col-12">
                                    <label class="form-label fw-bold text-dark"><?php echo e(__('اليوم الغياب يحسب ك')); ?></label>
                                    <div class="input-group">
                                        <input type="number" class="form-control"
                                            wire:model.defer="late_day_calculation" placeholder="0.00" step="1">
                                        <span class="input-group-text">يوم</span>
                                    </div>
                                    <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['late_day_calculation'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                    ...
                                    <select class="form-select fw-bold" wire:model.defer="shift_id">
                                        ...
                                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $shifts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $shift): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($shift->id); ?>">
                                              <?php echo e($shift->shift_type); ?> | <?php echo e($shift->start_time); ?> - <?php echo e($shift->end_time); ?> | <?php echo e($shift->name); ?>
            ...
            <div class="row mt-3">
                <div class="col-lg-6">
                    <div class="card border-0 shadow-sm">
                        <div class="card-header bg-gradient-primary text-white py-2">
                            <h6 class="card-title mb-0 font-family-cairo fw-bold">
                                <i class="fas fa-money-bill-wave me-2"></i><?php echo e(__('الحسابات')); ?>
                        ...
                        <div class="card-body py-3">
                            <div class="row g-3">
                                <div class="col-12">
                                    <label class="form-label fw-bold text-dark"><?php echo e(__('يتبع للحساب')); ?></label>
                                    <select class="form-select" wire:model.live="salary_basic_account_id">
                                        <option value=""><?php echo e(__('اختر الحساب الرئيسي للمرتب')); ?></option>
                                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $salary_basic_accounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $account): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($account['id']); ?>"><?php echo e($account['code']); ?> - <?php echo e($account['aname']); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
                                    </select>
                                    <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['salary_basic_account_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                ...
                <div class="col-lg-6">
                    <div class="card border-0 shadow-sm">
                        <div class="card-header bg-gradient-primary text-white py-2">
                            <h6 class="card-title mb-0 font-family-cairo fw-bold">
                                <i class="fas fa-money-bill-wave me-2"></i><?php echo e(__('الأرصده')); ?>
                        ...
                        <div class="card-body py-3">
                            <div class="row g-3">
                                <div class="col-12">
                                    <label class="form-label fw-bold text-dark"><?php echo e(__('الرصيد الأفتتاحى')); ?></label>
                                    <div class="input-group">
                                        <span class="input-group-text">ر.س</span>
                                        <input type="number" class="form-control" wire:model.defer="opening_balance" onclick="this.select()"
                                            placeholder="0.00" step="0.5">
                                    </div>
                                    <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['opening_balance'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
        ...
        <div x-show="activeTab === 'leaveBalances'" 
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-gradient-primary text-white py-2">
                    <h6 class="card-title mb-0 font-family-cairo fw-bold">
                        <i class="fas fa-calendar-check me-2"></i><?php echo e(__('رصيد الإجازات للموظف')); ?>
                ...
                <div class="card-body py-3">
                    ...
                    <div class="card border-primary mb-3">
                        <div class="card-header bg-light py-2">
                            <h6 class="card-title mb-0 font-family-cairo fw-bold text-primary">
                                <i class="fas fa-plus me-2"></i><?php echo e(__('إضافة رصيد إجازة جديد')); ?>
                        ...
                        <div class="card-body py-3">
                            <div class="row g-3">
                                <div class="col-md-8">
                                    <label class="form-label fw-bold text-dark"><?php echo e(__('اختر نوع الإجازة')); ?>
                                    ...
                                    <div class="position-relative">
                                        <div class="input-group">
                                            <input type="text" class="form-control"
                                                ...
                                                :placeholder="selectedLeaveTypeId ? '' : '<?php echo e(__('ابحث عن نوع الإجازة...')); ?>'"
                                                autocomplete="off">
                                            <button class="btn btn-outline-secondary" type="button"
                                    ...
                                    <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['selected_leave_type_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                    ...
                    <template x-if="leaveBalanceIds.length > 0">
                        <div>
                            <h6 class="fw-bold text-dark mb-3">
                                <i class="fas fa-list me-2"></i><?php echo e(__('أرصدة الإجازات المضافة')); ?>
                                ...
                                <table class="table table-bordered table-striped table-hover">
                                    <thead class="table-light">
                                        <tr>
                                            ...
                                            <th class="text-center fw-bold"><?php echo e(__('السنة')); ?> <span class="text-danger">*</span></th>
                                            ...
                                            <th class="text-center fw-bold"><?php echo e(__('إجراءات')); ?></th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="align-middle">
                                                    <textarea class="form-control form-control-sm" rows="1"
                                                        ...
                                                        placeholder="<?php echo e(__('أضف ملاحظات..')); ?>"></textarea>
                                                </td>
                                                <td class="align-middle text-center">
                                                    <button type="button" class="btn btn-outline-danger btn-sm"
                                                        @click="$wire.removeLeaveBalance(balanceKey)" title="<?php echo e(__('حذف')); ?>">
                                                        <i class="fas fa-times"></i>
                                                    </button>
                                                </td>
                                            </tr>
                    ...
                    <template x-if="leaveBalanceIds.length === 0">
                        <div class="alert alert-info text-center">
                            <i class="fas fa-info-circle me-2"></i>
                            <?php echo e(__('لم يتم إضافة أي رصيد إجازة بعد. استخدم النموذج أعلاه لإضافة رصيد إجازة.')); ?>
...
<?php /**PATH D:\Laragon\laragon\www\massar1.02\resources\views/livewire/hr-management/employees/partials/employee-form.blade.php ENDPATH**/ ?>