...
<div style="font-family: 'Cairo', sans-serif; direction: rtl;" x-data="employeeManager({
    ...
    leaveTypes: <?php echo \Illuminate\Support\Js::from($leaveTypes)->toHtml() ?>,
                                            ...
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['تعديل الموظفيين', 'حذف الموظفيين'])): ?>
                                                <td>
                                                    <button 
                                                        ...
                                                        title="<?php echo e(__('عرض')); ?>">
                                                        <span wire:loading wire:target="view(<?php echo e($employee->id); ?>)" class="spinner-border spinner-border-sm align-middle" role="status" aria-hidden="true"></span>
                                                        <i class="las la-eye fa-lg" wire:loading.remove wire:target="view(<?php echo e($employee->id); ?>)"></i>
                                                    </button>
                                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('تعديل الموظفيين')): ?>
                                                        <a 
                                                            wire:click="edit(<?php echo e($employee->id); ?>)"
                                                            wire:loading.attr="disabled"
                                                            wire:target="edit"
                                                            class="btn btn-success btn-sm me-1"
                                                            title="<?php echo e(__('تعديل')); ?>">
                                                            <span wire:loading wire:target="edit(<?php echo e($employee->id); ?>)" class="spinner-border spinner-border-sm align-middle" role="status" aria-hidden="true"></span>
                                                            <i class="las la-edit fa-lg" wire:loading.remove wire:target="edit(<?php echo e($employee->id); ?>)"></i>
                                                        </a>
                                                    <?php endif; ?>
                                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('حذف الموظفيين')): ?>
                                                        <button 
                                                            ...
                                                            <span wire:loading wire:target="delete(<?php echo e($employee->id); ?>)" class="spinner-border spinner-border-sm align-middle" role="status" aria-hidden="true"></span>
                                                            <i class="las la-trash fa-lg" wire:loading.remove wire:target="delete(<?php echo e($employee->id); ?>)"></i>
                                                        </button>
                                                    <?php endif; ?>
                                                </td>
                                            <?php endif; ?>
...
<?php $__env->stopPush(); ?><?php /**PATH D:\Laragon\laragon\www\massar1.02\resources\views\livewire/hr-management/employees/manage-employee.blade.php ENDPATH**/ ?>