            ...
            <div class="card-body">
                <div class="mb-3 no-print">
                    <button type="button" id="expand-all" class="btn btn-primary btn-lg">
                        <i class="fas fa-expand-alt me-1"></i><?php echo e(__('فتح الكل')); ?>

                    </button>
                    <button type="button" id="collapse-all" class="btn btn-secondary btn-lg">
                        <i class="fas fa-compress-alt me-1"></i><?php echo e(__('طي الكل')); ?>

                    </button>
                    <button type="button" id="print-tree" class="btn btn-success btn-lg">
                        <i class="fas fa-print me-1"></i><?php echo e(__('طباعة')); ?>
                        ...
                        <div id="printed-area" class="tree-container">
                            ...
                            <ul>
                                <?php $__currentLoopData = $accounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $account): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php echo $__env->make('reports.partials.account-node', ['account' => $account], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php echo $__env->make('admin.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Laragon\laragon\www\massar1.02\resources\views/reports/accounts-tree.blade.php ENDPATH**/ ?>