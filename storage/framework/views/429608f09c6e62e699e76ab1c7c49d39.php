...
<div dir="rtl" style="font-family: 'Cairo', sans-serif;">
    ...
    <!--[if BLOCK]><![endif]--><?php if(session()->has('success')): ?>
        <div class="alert alert-success alert-dismissible fade show font-family-cairo" role="alert">
            <i class="las la-check-circle me-2"></i><?php echo e(session('success')); ?>
    ...
    <?php if(session()->has('error')): ?>
        <div class="alert alert-danger alert-dismissible fade show font-family-cairo" role="alert">
            <i class="las la-exclamation-circle me-2"></i><?php echo e(session('error')); ?>
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('إضافة البصمات')): ?>
            <div class="col-12 d-flex justify-content-end gap-2">
                <button class="btn btn-success font-family-cairo fw-bold" wire:click="openImportModal">
                    <i class="las la-file-excel"></i> <?php echo e(__('استيراد من Excel')); ?>
    ...
    <!--[if BLOCK]><![endif]--><?php if($showImportModal): ?>
        <div class="modal fade show d-block" tabindex="-1" style="background:rgba(0,0,0,0.5);">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title font-family-cairo"><?php echo e(__('استيراد بيانات البصمات من Excel')); ?></h5>
                        <button type="button" class="btn-close"
                            wire:click="$set('showImportModal', false)"></button>
                    </div>
                    <div class="modal-body">
                        <div class="mb-3">
                            <p class="font-family-cairo mb-2"><?php echo e(__('ملاحظات مهمة:')); ?></p>
                            <ul class="font-family-cairo" style="font-size: 0.9rem;">
                                <li><?php echo e(__('يجب أن يحتوي ملف Excel على عمود "AC-No." (إجباري) الذي يمثل رقم البصمة')); ?></li>
                                <li><?php echo e(__('يجب أن يحتوي ملف Excel على عمود "Name" (إجباري) الذي يمثل اسم البصمة')); ?></li>
                                <li><?php echo e(__('يجب أن يحتوي ملف Excel على عمود "Time" (إجباري) الذي يحتوي على التاريخ والوقت معاً')); ?></li>
                                <li><?php echo e(__('تنسيق عمود Time: "DD/MM/YYYY HH:MM ص" أو "DD/MM/YYYY HH:MM م" (مثال: "03/01/2025 04:20 ص")')); ?></li>
                                <li><?php echo e(__('سيتم البحث عن الموظف بناءً على رقم البصمة (AC-No.) واسم البصمة (Name) معاً')); ?></li>
                                <li><?php echo e(__('سيتم تحديد نوع البصمة (دخول/خروج) تلقائياً بناءً على وقت البصمة ونطاق الوردية')); ?></li>
                                <li><?php echo e(__('التاريخ والوقت إجباريان لأن المعالجة والرواتب تعتمد عليهما')); ?></li>
                                <li><?php echo e(__('إذا لم يتم العثور على الموظف أو كانت البيانات غير صحيحة، سيتم تخطي السجل')); ?></li>
                                <li><?php echo e(__('السجلات المكررة (نفس الموظف، التاريخ، والوقت) سيتم تخطيها')); ?></li>
                            </ul>
                        </div>
                        <form wire:submit.prevent="importExcel">
                            <div class="mb-3">
                                <label class="form-label font-family-cairo fw-bold"><?php echo e(__('ملف Excel')); ?></label>
                                <input type="file" class="form-control font-family-cairo" 
                                    accept=".xls,.xlsx,.csv"
                                    wire:model="excelFile"
                                    <?php if($isReadingFile || $isFileRead): ?> disabled <?php endif; ?>>
                                <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['excelFile'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                <small class="text-muted font-family-cairo"><?php echo e(__('صيغ المدعومة: .xls, .xlsx, .csv')); ?></small>
                            </div>

                            
                            <!--[if BLOCK]><![endif]--><?php if($isReadingFile): ?>
                                <div class="mb-3 p-3 bg-light rounded">
                                    <div class="d-flex align-items-center mb-2">
                                        <div class="spinner-border spinner-border-sm text-primary me-2" role="status">
                                            <span class="visually-hidden">جاري القراءة...</span>
                                        </div>
                                        <span class="font-family-cairo fw-bold"><?php echo e(__('جاري قراءة وتحليل الملف...')); ?></span>
                                    </div>
                                    <!--[if BLOCK]><![endif]--><?php if($importTotalRows > 0): ?>
                                        <div class="progress mb-2" style="height: 25px;">
                                            <div class="progress-bar progress-bar-striped progress-bar-animated" 
                                                 role="progressbar" 
                                                 style="width: <?php echo e($importTotalRows > 0 ? min(100, ($importProgress / $importTotalRows) * 100) : 0); ?>%"
                                                 aria-valuenow="<?php echo e($importProgress); ?>" 
                                                 aria-valuemin="0" 
                                                 aria-valuemax="<?php echo e($importTotalRows); ?>">
                                                <span class="font-family-cairo fw-bold text-white">
                                                    <?php echo e($importProgress); ?> / <?php echo e($importTotalRows); ?> صف
                                                </span>
                                            </div>
                                        </div>
                                        <small class="text-muted font-family-cairo">
                                            <?php echo e(__('تم معالجة')); ?> <?php echo e($importProgress); ?> <?php echo e(__('من')); ?> <?php echo e($importTotalRows); ?> <?php echo e(__('صف')); ?>
                            ...
                            <!--[if BLOCK]><![endif]--><?php if($isFileRead): ?>
                                <div class="mb-3 p-3 rounded" 
                                     style="background-color: <?php echo e($importSuccessCount > 0 ? '#d4edda' : '#f8d7da'); ?>;">
                                    <div class="d-flex align-items-center mb-2">
                                        ...
                                        <span class="font-family-cairo fw-bold" style="font-size: 1.1rem;">
                                            <?php echo e(__('تم رفع وتحليل الملف بنجاح')); ?>

                                        </span>
                                    </div>
                                    <div class="mt-2">
                                        <span class="badge bg-success me-2 font-family-cairo">
                                            <?php echo e(__('ناجح:')); ?> <?php echo e($importSuccessCount); ?>

                                        </span>
                                        <!--[if BLOCK]><![endif]--><?php if($importFailedCount > 0): ?>
                                            <span class="badge bg-danger me-2 font-family-cairo">
                                                <?php echo e(__('فشل:')); ?> <?php echo e($importFailedCount); ?>

                                            </span>
                                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                    </div>
                                    <!--[if BLOCK]><![endif]--><?php if($importFailedCount > 0 && count($importErrors) > 0 && count($importErrors) <= 5): ?>
                                        <div class="mt-2">
                                            <small class="text-danger font-family-cairo">
                                                <strong><?php echo e(__('الأخطاء:')); ?></strong><br>
                                                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = array_slice($importErrors, 0, 5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $error): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    • <?php echo e($error); ?><br>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                <!--[if BLOCK]><![endif]--><?php if(count($importErrors) > 5): ?>
                                                    ... <?php echo e(__('و')); ?> <?php echo e(count($importErrors) - 5); ?> <?php echo e(__('أخطاء أخرى')); ?>
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary font-family-cairo"
                                    ...
                                    <?php if($isReadingFile): ?> disabled <?php endif; ?>>
                                    <?php echo e(__('إلغاء')); ?>
                                ...
                                <!--[if BLOCK]><![endif]--><?php if(!$isFileRead): ?>
                                    <button type="submit" class="btn btn-primary font-family-cairo"
                                        ...
                                        <?php if($isReadingFile || !$excelFile): ?> disabled <?php endif; ?>>
                                        <span wire:loading.remove wire:target="importExcel">
                                            <i class="las la-file-upload me-1"></i> <?php echo e(__('قراءة وتحليل الملف')); ?>

                                        </span>
                                        <span wire:loading wire:target="importExcel">
                                            <span class="spinner-border spinner-border-sm me-2" role="status"></span>
                                            <?php echo e(__('جاري القراءة...')); ?>
                                ...
                                <?php else: ?>
                                    <button type="button" class="btn btn-success font-family-cairo"
                                        ...
                                        <span wire:loading.remove wire:target="confirmImport">
                                            <i class="las la-save me-1"></i> <?php echo e(__('تأكيد حفظ البيانات')); ?>

                                        </span>
                                        <span wire:loading wire:target="confirmImport">
                                            <span class="spinner-border spinner-border-sm me-2" role="status"></span>
                                            <?php echo e(__('جاري الحفظ...')); ?>
