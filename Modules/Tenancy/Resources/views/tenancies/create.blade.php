                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select name="company_size" class="form-select @error('company_size') is-invalid @enderror">
                                    ...
                                    <option value="1-5" {{ old('company_size') == '1-5' ? 'selected' : '' }}>1-5
                                        {{ __('Employees') }}</option>
                                    <option value="6-20" {{ old('company_size') == '6-20' ? 'selected' : '' }}>6-20
                                        {{ __('Employees') }}</option>
                                    <option value="21-100" {{ old('company_size') == '21-100' ? 'selected' : '' }}>21-100
                                        {{ __('Employees') }}</option>
                                    <option value="100+" {{ old('company_size') == '100+' ? 'selected' : '' }}>100+
                                        {{ __('Employees') }}</option>
                                </select>
                                @error('company_size')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                        ...
                                        <div class="col-md-4 mb-2">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="enabled_modules[]"
                                                    ...
                                                    {{ is_array(old('enabled_modules')) && in_array($key, old('enabled_modules')) ? 'checked' : '' }}>
