...
@section('content')
    @include('components.breadcrumb', [
        ...
        'items' => [['label' => __('Home'), 'url' => route('admin.dashboard')], ['label' => __('Tenants'), 'url' => route('tenancy.index')], ['label' => __('Edit')]],
    ])
                ...
                <div class="card-body">
                    <form action="{{ route('tenancy.update', $tenant->id) }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    <input type="text" name="subdomain" class="form-control @error('subdomain') is-invalid @enderror" value="{{ old('subdomain', $tenant->id) }}" required>
                                ...
                                <small class="text-muted">{{ __('Note: Changing subdomain may affect tenant accessibility.') }}</small>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <label class="form-label">{{ __('Admin Password') }} ({{ __('Leave blank to keep current') }})</label>
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" name="contact_number" class="form-control @error('contact_number') is-invalid @enderror" value="{{ old('contact_number', $tenant->contact_number) }}">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select name="company_size" class="form-select @error('company_size') is-invalid @enderror">
                                    ...
                                    <option value="1-5" {{ old('company_size', $tenant->company_size) == '1-5' ? 'selected' : '' }}>1-5 {{ __('Employees') }}</option>
                                    <option value="6-20" {{ old('company_size', $tenant->company_size) == '6-20' ? 'selected' : '' }}>6-20 {{ __('Employees') }}</option>
                                    <option value="21-100" {{ old('company_size', $tenant->company_size) == '21-100' ? 'selected' : '' }}>21-100 {{ __('Employees') }}</option>
                                    <option value="100+" {{ old('company_size', $tenant->company_size) == '100+' ? 'selected' : '' }}>100+ {{ __('Employees') }}</option>
                                </select>
                                @error('company_size') <div class="invalid-feedback">{{ $message }}</div> @enderror
                            </div>
                            <div class="col-md-4 mb-3">
                                <label class="form-label">{{ __('User Position') }}</label>
                                <input type="text" name="user_position" class="form-control @error('user_position') is-invalid @enderror" value="{{ old('user_position', $tenant->user_position) }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="date" name="subscription_start_at" class="form-control @error('subscription_start_at') is-invalid @enderror" value="{{ old('subscription_start_at', $tenant->subscription_start_at ? $tenant->subscription_start_at->format('Y-m-d') : '') }}">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="date" name="subscription_end_at" class="form-control @error('subscription_end_at') is-invalid @enderror" value="{{ old('subscription_end_at', $tenant->subscription_end_at ? $tenant->subscription_end_at->format('Y-m-d') : '') }}">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="referral_code" class="form-control @error('referral_code') is-invalid @enderror" value="{{ old('referral_code', $tenant->referral_code) }}">
                                @error('referral_code') <div class="invalid-feedback">{{ $message }}</div> @enderror
                            </div>
                            <div class="col-md-6 mb-3">
                                <div class="mt-4">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" name="status" value="1" id="statusSwitch" {{ old('status', $tenant->status) ? 'checked' : '' }}>
