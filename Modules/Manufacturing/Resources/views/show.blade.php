        ...
        <div class="row mb-4">
            <div class="col-md-6">
                <div class="card shadow-sm h-100">
                    <div class="card-header bg-light">
                        <h6 class="mb-0"><i
                                class="fas fa-info-circle me-2"></i>{{ __('manufacturing::manufacturing.invoice information') }}
                        </h6>
                    </div>
                    <div class="card-body">
                        <table class="table table-sm table-borderless">
                            <tr>
                                <td width="40%" class="text-muted">
                                    {{ __('manufacturing::manufacturing.invoice number') }}:</td>
                            ...
                            @if ($invoice->expected_time)
                                <tr>
                                    ...
                                    <td><strong class="text-primary">{{ rtrim(rtrim($invoice->expected_time, '0'), ':') }}
                                            {{ __('manufacturing::manufacturing.hours') }}</strong></td>
                                </tr>
                            @endif
                            @if ($invoice->details)
                                <tr>
                                    <td class="text-muted">{{ __('manufacturing::manufacturing.actual time') }}:</td>
                                    <td><strong class="text-success">{{ $invoice->details }}</strong></td>
                                </tr>
                            @endif
                        </table>
                    </div>
            ...
            <div class="col-md-6">
                <div class="card shadow-sm h-100">
                    <div class="card-header bg-light">
                        <h6 class="mb-0"><i
                                class="fas fa-building me-2"></i>{{ __('manufacturing::manufacturing.additional information') }}
                        </h6>
                    </div>
                    <div class="card-body">
                        <table class="table table-sm table-borderless">
                            <tr>
                                <td width="40%" class="text-muted">{{ __('manufacturing::manufacturing.employee') }}:
                                </td>
                            ...
                            <tr>
                                ...
                                <td>{{ $invoice->acc3Head->aname ?? __('manufacturing::manufacturing.operational center main') }}
                                </td>
                            </tr>
                        </table>
                    </div>
                                ...
                                <table class="table table-bordered table-hover align-middle">
                                    <thead class="table-light">
                                        <tr class="text-center">
                                            ...
                                            <th width="15%">{{ __('manufacturing::manufacturing.cost percentage') }} %
                                            </th>
                                    ...
                                    <tbody>
                                        @foreach ($products as $index => $product)
                                            <tr>
                                                ...
                                                <td class="text-center">{{ number_format($product['unit_cost'], 2) }}
                                    ...
                                    <tfoot class="table-light">
                                        <tr>
                                            <td colspan="4" class="text-end">
                                                <strong>{{ __('manufacturing::manufacturing.total') }}:</strong>
                                            </td>
                                            <td class="text-center">
                                                <strong
                                    ...
                                    <tbody>
                                        @foreach ($rawMaterials as $index => $material)
                                            <tr>
                                                ...
                                                <td class="text-center">{{ number_format($material['unit_cost'], 2) }}
                                                    {{ __('manufacturing::manufacturing.egp') }}</td>
                                                <td class="text-center">
                                                    <strong
                            ...
                            <div class="card-body p-3 text-center">
                                <div class="d-flex align-items-center justify-content-between">
                                    <div class="text-start flex-grow-1">
                                        <small
                                            class="text-muted d-block mb-1">{{ __('manufacturing::manufacturing.total raw materials') }}</small>
                                        <h5 class="mb-0 text-info fw-bold">
                                            {{ number_format($totals['raw_materials'], 2) }}</h5>
                        ...
                        <div class="card border-0 shadow-sm h-100">
                            <div class="card-body p-3 text-center">
                                <div class="d-flex align-items-center justify-content-between">
                                    <div class="text-start flex-grow-1">
                                        <small
                                            class="text-muted d-block mb-1">{{ __('manufacturing::manufacturing.total expenses') }}</small>
                                        <h5 class="mb-0 text-warning fw-bold">{{ number_format($totals['expenses'], 2) }}
                                        </h5>
                                        <small class="text-muted">{{ __('manufacturing::manufacturing.egp') }}</small>
                                    </div>
                        ...
                        <div class="card border-0 shadow-sm h-100">
                            <div class="card-body p-3 text-center">
                                <div class="d-flex align-items-center justify-content-between">
                                    <div class="text-start flex-grow-1">
                                        <small
                                            class="text-muted d-block mb-1">{{ __('manufacturing::manufacturing.total invoice cost') }}</small>
                                        <h5 class="mb-0 text-danger fw-bold">
                                            {{ number_format($totals['manufacturing_cost'], 2) }}</h5>
                                        <small class="text-muted">{{ __('manufacturing::manufacturing.egp') }}</small>
                                    </div>
                        ...
                        <div class="card border-0 shadow-sm h-100">
                            <div class="card-body p-3 text-center">
                                <div class="d-flex align-items-center justify-content-between">
                                    <div class="text-start flex-grow-1">
                                        <small
                                            class="text-muted d-block mb-1">{{ __('manufacturing::manufacturing.total products value') }}</small>
                                        <h5 class="mb-0 text-success fw-bold">{{ number_format($totals['products'], 2) }}
                                        </h5>
                                        <small class="text-muted">{{ __('manufacturing::manufacturing.egp') }}</small>
                                    </div>
                        ...
                        <div class="card border-0 shadow-sm h-100">
                            <div class="card-body p-3">
                                <div class="d-flex align-items-center justify-content-between">
                                    <div class="text-start flex-grow-1">
                                        <small
                                            class="text-muted d-block mb-1">{{ __('manufacturing::manufacturing.standard cost (template)') }}</small>
                        ...
                        <div class="card border-0 shadow-sm h-100">
                            <div class="card-body p-3">
                                ...
                                <div class="d-flex align-items-center justify-content-between">
                                    <div class="text-start flex-grow-1">
                                        <small
                                            class="text-muted d-block mb-1">{{ __('manufacturing::manufacturing.variance (difference)') }}</small>
                                        ...
                                        <small class="text-muted">{{ __('manufacturing::manufacturing.egp') }}</small>
                                        <span
                                            class="badge bg-{{ $color }} ms-2">{{ number_format(abs($variancePercentage), 2) }}%</span>
                                    </div>
