<div class="container-fluid p-3 p-md-4">
    <div class="card">
        <div class="card-header">
            <h3 class="card-title font-hold fw-bold mb-0">{{ __('projects::projects.edit_project') }}</h3>
        </div>
        <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-sm-6 col-md-4 col-lg-2 mb-3">
                        ...
                        <select class="form-select font-hold fw-bold @error('priority') is-invalid @enderror"
                            ...
                            <option value="medium">{{ __('projects::projects.priority_medium') }}</option>
                    ...
                    <div class="col-12 col-sm-6 col-md-4 col-lg-2 mb-3">
                        ...
                        <input type="number" step="0.01" class="form-control @error('budget') is-invalid @enderror"
                            wire:model="budget" id="budget" placeholder="{{ __('projects::projects.budget') }}">
                        @error('budget')
                            <div class="invalid-feedback font-hold">
                                {{ $message }}
                            </div>
                ...
                <div class="card-footer bg-transparent border-top-0">
                    <div class="d-flex flex-column flex-sm-row justify-content-end gap-2">
                        ...
                        <button type="submit" class="btn btn-main order-1 order-sm-2">
                            <i class="las la-save"></i> {{ __('projects::projects.save_changes') }}
                        </button>
                    </div>
                </div>
            </form>
