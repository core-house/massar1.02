...
class ProjectController extends Controller
{
    ...
    public function show($id)
    {
        ...
        return view('projects::projects.show', compact('project', 'operations', 'equipments', 'vouchers', 'equipmentOperations'));
    }
    ...
    public function statistics()
    {
            ...
            $raw = Project::select(
                ...
                ->map(function ($item) use ($statusMap) {
                    return [
                        ...
                        'avg_duration' => $item->avg_duration !== null ? round((float) $item->avg_duration, 1) : 0,
        ...
        return view('projects::projects.statistics', compact('sortedStatistics', 'overallTotal'));
    }
}
