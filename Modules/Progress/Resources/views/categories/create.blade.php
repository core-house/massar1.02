...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active">{{ __('general.add_new_category') }}</li>
@endsection

@section('title', __('general.add_new_category'))
...
<div class="container">
    <div class="main-card card">
        <div class="card-header text-white">
            <h5 class="mb-0"><i class="fas fa-plus-circle me-2"></i> {{ __('general.add_new_category') }}</h5>
        </div>
        <div class="card-body">
            @if($errors->any())
            ...
            <form action="{{ route('progress.categories.store') }}" method="POST">
                @csrf
                <div class="mb-4">
