                                ...
                                <template x-for="(row, index) in items" :key="row.id">
                                            <tr class="bg-white" :class="{'table-active': selectedItems.includes(index)}">
                                                ...
                                                <td>
                                                    ...
                                                    <select class="form-select" :value="row.predecessor" @change="row.predecessor = $event.target.value; calculateAllDates()">
                                                ...
                                                <!-- Dependency -->
                                                <td>
                                                    <select class="form-select" :name="'items['+index+'][dependency_type]'" :value="row.dependency_type" @change="row.dependency_type = $event.target.value; calculateAllDates()">
                                                                        ...
                                                                        <template x-for="(wrapper, groupIdx) in group.items" :key="wrapper.data.id">
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    ...
                                                                                    <select class="form-select" :value="wrapper.data.predecessor" @change="wrapper.data.predecessor = $event.target.value; calculateAllDates()">
                                                                                        <option value="">بدون</option>
                                                                                ...
                                                                                <td>
                                                                                    <select class="form-select" :name="'items['+wrapper.originalIndex+'][dependency_type]'" :value="wrapper.data.dependency_type" @change="wrapper.data.dependency_type = $event.target.value; calculateAllDates()">
