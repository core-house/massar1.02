...
@endsection
@section('title', __('general.add_new_client'))
...
<div class="container">
    <div class="main-card card">
        <div class="card-header text-white">
            <h5 class="mb-0"><i class="fas fa-user-plus me-2"></i> {{ __('general.add_new_client') }}</h5>
        </div>
        <div class="card-body">
            <form action="{{ route('progress.clients.store') }}" method="POST">
                @csrf
                <div class="row mb-4">
