...
<div class="container">
    <div class="main-card card">
        <div class="card-header text-white">
            <h5 class="mb-0"><i class="fas fa-tags me-2"></i> {{ __('general.add_item_status') }}</h5>
        </div>
        <div class="card-body">
            <form action="{{ route('progress.item-statuses.store') }}" method="POST">
                @csrf
                <div class="mb-4">
                    ...
                    <div class="col-md-6 mb-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="color" class="form-control @error('color') is-invalid @enderror"
                                   value="{{ old('color') }}" placeholder="#28a745">
                            @error('color')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6 mb-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="icon" class="form-control @error('icon') is-invalid @enderror"
                                   value="{{ old('icon') }}" placeholder="fa-check-circle">
                            @error('icon')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
