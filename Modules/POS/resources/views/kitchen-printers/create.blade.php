...
<div class="kitchen-printer-form-container">
    <div class="page-header">
        ...
        <div class="page-title">
            <h1>{{ __('pos.add_printer_station') }}</h1>
            <p class="page-subtitle">{{ __('pos.add_printer_station_desc') }}</p>
        </div>
    </div>

    <div class="form-card">
        <form action="{{ route('kitchen-printers.store') }}" method="POST" x-data="printerForm()">
            @csrf
