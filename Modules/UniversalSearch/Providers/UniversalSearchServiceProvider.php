...
namespace Modules\UniversalSearch\Providers;
...
class UniversalSearchServiceProvider extends ServiceProvider
{
    use PathNamespace;

    protected string $name = 'UniversalSearch';

    protected string $nameLower = 'universalsearch';
