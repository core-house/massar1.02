        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h5>{{ __('maintenance::maintenance.edit') }}</h5>
                </div>
                <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="status" id="status"
                                    ...
                                    <option value="0" {{ old('status', $maintenance->status) == '0' ? 'selected' : '' }}>{{ __('maintenance::maintenance.pending') }}</option>
                                    <option value="1" {{ old('status', $maintenance->status) == '1' ? 'selected' : '' }}>{{ __('maintenance::maintenance.in_progress') }}</option>
                                    <option value="2" {{ old('status', $maintenance->status) == '2' ? 'selected' : '' }}>{{ __('maintenance::maintenance.completed') }}</option>
                                    <option value="3" {{ old('status', $maintenance->status) == '3' ? 'selected' : '' }}>{{ __('maintenance::maintenance.cancelled') }}</option>
                                </select>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="date" name="accural_date" id="accural_date"
                                    ...
                                    value="{{ old('accural_date', $maintenance->accural_date?->format('Y-m-d')) }}" required>
                        ...
                        <div class="row" x-data="{ spare: {{ old('spare_parts_cost', $maintenance->spare_parts_cost ?? 0) }}, labor: {{ old('labor_cost', $maintenance->labor_cost ?? 0) }}, total: {{ old('total_cost', $maintenance->total_cost ?? 0) }} }">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="maintenance_type" id="maintenance_type"
                                    ...
                                    <option value="periodic" {{ old('maintenance_type', $maintenance->maintenance_type) == 'periodic' ? 'selected' : '' }}>{{ __('maintenance::maintenance.periodic') }}</option>
                                    <option value="emergency" {{ old('maintenance_type', $maintenance->maintenance_type) == 'emergency' ? 'selected' : '' }}>{{ __('maintenance::maintenance.emergency') }}</option>
                                    <option value="repair" {{ old('maintenance_type', $maintenance->maintenance_type) == 'repair' ? 'selected' : '' }}>{{ __('maintenance::maintenance.repair') }}</option>
                                </select>
                            ...
                            <div class="col-md-9 mb-3">
                                ...
                                <textarea name="notes" id="notes" rows="3"
                                    class="form-control @error('notes') is-invalid @enderror">{{ old('notes', $maintenance->notes) }}</textarea>
