    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                <h4 class="page-title">{{ __("Add New Status") }}</h4>
            </div>
        </div>
    </div>
                    ...
                    <form action="{{ route('myresources.statuses.store') }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="icon" id="icon" class="form-control @error('icon') is-invalid @enderror" value="{{ old('icon') }}" placeholder="{{ __('Example') }}: fas fa-check-circle">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="color" id="color" class="form-select @error('color') is-invalid @enderror">
                                    <option value="primary" {{ old('color') == 'primary' ? 'selected' : '' }}>{{ __("Blue") }}</option>
                                    <option value="success" {{ old('color') == 'success' ? 'selected' : '' }}>{{ __("Green") }}</option>
                                    <option value="info" {{ old('color', 'info') == 'info' ? 'selected' : '' }}>{{ __("Light") }}</option>
                                    <option value="warning" {{ old('color') == 'warning' ? 'selected' : '' }}>{{ __("Yellow") }}</option>
                                    <option value="danger" {{ old('color') == 'danger' ? 'selected' : '' }}>{{ __("Red") }}</option>
