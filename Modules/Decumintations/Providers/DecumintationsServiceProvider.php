...
namespace Modules\Decumintations\Providers;
...
class DecumintationsServiceProvider extends ServiceProvider
{
    use PathNamespace;

    protected string $name = 'Decumintations';

    protected string $nameLower = 'decumintations';
