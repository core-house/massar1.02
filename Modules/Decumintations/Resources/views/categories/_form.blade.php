<div class="row g-3">
    <div class="col-md-12">
        <label class="form-label">{{ __('decumintations.category_name') }} <span class="text-danger">*</span></label>
    ...
    <div class="col-md-6">
        <label class="form-label">{{ __('decumintations.color') }}</label>
    ...
    <div class="col-md-6">
        <label class="form-label">{{ __('decumintations.icon') }}</label>
