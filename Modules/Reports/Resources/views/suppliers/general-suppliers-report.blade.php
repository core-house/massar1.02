            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">{{ __('reports::reports.general_suppliers_report') }}</h4>
                    </div>
                    <div class="card-body">
                        <!-- Filters -->
                        <div class="row mb-3">
                            ...
                            <div class="col-md-3">
                                <label for="supplier_id" class="form-label">{{ __('reports::reports.supplier') }}</label>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-2">
                                <div class="card bg-success text-white">
                                    <div class="card-body">
                                        <h6 class="card-title">{{ __('reports::reports.total_purchases') }}</h6>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if ($transaction->credit > 0)
                                                    <span class="badge bg-success">{{ __('reports::reports.Purchase Report') }}</span>
