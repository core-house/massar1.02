        ...
        <div class="col-12">
            <div class="page-title-box no-print">
                <div class="d-flex justify-content-between align-items-center">
                    <h4 class="page-title">{{ __('recruitment.contract_details') }}: #{{ $contract->id }}</h4>
                    <div class="d-flex gap-2">
                        <button onclick="window.print()" class="btn btn-info">
                            <i class="fas fa-print"></i> {{ __('Print') }}
                        </button>
                        <a href="{{ route('recruitment.contracts.index') }}" class="btn btn-secondary">
        ...
        <div class="col-12">
            <div class="card printable-content">
                <div class="card-header bg-primary text-white">
                    <h5 class="mb-0"><i class="fas fa-file-contract"></i> {{ __('recruitment.contract_information') }}</h5>
                </div>
                <div class="card-body">
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="form-control-static">{{ $contract->employee->name ?? 'N/A' }}</div>
                        </div>
                    </div>
                    @endif
                </div>
