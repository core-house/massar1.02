                        ...
                        <tr class="{{ $capa->isOverdue() ? 'table-danger' : '' }}">
                            ...
                            <td>
                                <div class="btn-group" role="group">
                                    <a href="{{ route('quality.capa.show', $capa) }}" class="btn btn-sm btn-info" title="عرض">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    <a href="{{ route('quality.capa.edit', $capa) }}" class="btn btn-sm btn-warning" title="تعديل">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <button type="button" class="btn btn-sm btn-danger" 
                                            data-bs-toggle="modal" 
                                            data-bs-target="#deleteModal{{ $capa->id }}" 
                                            title="حذف">
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <form action="{{ route('quality.capa.destroy', $capa) }}" method="POST" class="d-inline">
                                                    @csrf
                                                    @method('DELETE')
