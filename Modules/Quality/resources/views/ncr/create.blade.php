...
<div class="container-fluid">
    <div class="row mb-4">
        <div class="col-12">
            <h2><i class="fas fa-plus-circle me-2"></i>{{ __("quality::quality.new ncr") }}</h2>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="batch_number" class="form-control" 
                                       value="{{ old('batch_number') }}" placeholder="{{ __("quality::quality.optional") }}">
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="source" class="form-select @error('source') is-invalid @enderror">
                                    ...
                                    <option value="receiving_inspection" {{ old('source') == 'receiving_inspection' ? 'selected' : '' }}>{{ __("quality::quality.receiving inspection") }}</option>
                                    <option value="in_process" {{ old('source') == 'in_process' ? 'selected' : '' }}>{{ __("quality::quality.in-process inspection") }}</option>
                                    <option value="final_inspection" {{ old('source') == 'final_inspection' ? 'selected' : '' }}>{{ __("quality::quality.final inspection") }}</option>
                                    <option value="customer_complaint" {{ old('source') == 'customer_complaint' ? 'selected' : '' }}>{{ __("quality::quality.customer complaint inspection") }}</option>
                                    <option value="internal_audit" {{ old('source') == 'internal_audit' ? 'selected' : '' }}>{{ __("quality::quality.internal") }}</option>
                                    <option value="supplier_notification" {{ old('source') == 'supplier_notification' ? 'selected' : '' }}>{{ __("quality::quality.supplier notification") }}</option>
                                </select>
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <textarea name="problem_description" rows="4" 
                                          ...
                                          placeholder="{{ __("quality::quality.explain the problem in detail...") }}">{{ old('problem_description') }}</textarea>
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <textarea name="immediate_action" rows="3" class="form-control" 
                                          placeholder="{{ __("quality::quality.what immediate action was taken?") }}">{{ old('immediate_action') }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-4">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <select name="severity" class="form-select @error('severity') is-invalid @enderror">
                                <option value="minor" {{ old('severity', 'minor') == 'minor' ? 'selected' : '' }}>{{ __("quality::quality.minor") }}</option>
                                <option value="major" {{ old('severity') == 'major' ? 'selected' : '' }}>{{ __("quality::quality.major") }}</option>
                                <option value="critical" {{ old('severity') == 'critical' ? 'selected' : '' }}>{{ __("quality::quality.critical") }}</option>
                            </select>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="disposition" class="form-select">
                                ...
                                <option value="rework" {{ old('disposition') == 'rework' ? 'selected' : '' }}>{{ __("quality::quality.rework") }}</option>
                                <option value="scrap" {{ old('disposition') == 'scrap' ? 'selected' : '' }}>{{ __("quality::quality.scrap") }}</option>
                                <option value="return_to_supplier" {{ old('disposition') == 'return_to_supplier' ? 'selected' : '' }}>{{ __("quality::quality.return to supplier") }}</option>
                                <option value="use_as_is" {{ old('disposition') == 'use_as_is' ? 'selected' : '' }}>{{ __("quality::quality.use as is") }}</option>
                                <option value="repair" {{ old('disposition') == 'repair' ? 'selected' : '' }}>{{ __("quality::quality.repair") }}</option>
                                <option value="downgrade" {{ old('disposition') == 'downgrade' ? 'selected' : '' }}>{{ __("quality::quality.downgrade") }}</option>
                            </select>
                        </div>
                ...
                <div class="d-grid gap-2">
                    <button type="submit" class="btn btn-danger btn-lg">
                        <i class="fas fa-save me-2"></i>{{ __("quality::quality.save report") }}
                    </button>
