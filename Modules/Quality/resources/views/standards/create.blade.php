...
<div class="container-fluid">
    <div class="row mb-4">
        <div class="col-12">
            <h2><i class="fas fa-plus-circle me-2"></i>معيار جودة جديد</h2>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <textarea name="description" rows="3" class="form-control" 
                                          placeholder="وصف تفصيلي للمعيار...">{{ old('description') }}</textarea>
                            </div>

                            <div class="col-12 mb-3">
                                <label class="form-label">طريقة الاختبار</label>
                                <textarea name="test_method" rows="3" class="form-control" 
                                          placeholder="اشرح طريقة تنفيذ الاختبار...">{{ old('test_method') }}</textarea>
                            </div>
            ...
            <div class="col-lg-4">
                ...
                <div class="d-grid gap-2">
                    <button type="submit" class="btn btn-success btn-lg">
                        <i class="fas fa-save me-2"></i>حفظ المعيار
                    </button>
