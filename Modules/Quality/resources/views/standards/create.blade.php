                    ...
                    <form action="{{ route('quality.standards.store') }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('standard_code') is-invalid @enderror" 
                                       id="standard_code" name="standard_code" value="{{ old('standard_code') }}" required>
                                @error('standard_code')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <input type="text" class="form-control @error('standard_name') is-invalid @enderror" 
                                       id="standard_name" name="standard_name" value="{{ old('standard_name') }}" required>
                                @error('standard_name')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea class="form-control @error('test_method') is-invalid @enderror" 
                                          id="test_method" name="test_method" rows="3">{{ old('test_method') }}</textarea>
                                @error('test_method')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" class="form-control @error('sample_size') is-invalid @enderror" 
                                       id="sample_size" name="sample_size" value="{{ old('sample_size', 1) }}" min="1" required>
                                @error('sample_size')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="form-select @error('test_frequency') is-invalid @enderror" 
                                    ...
                                    <option value="per_batch" {{ old('test_frequency') == 'per_batch' ? 'selected' : '' }}>لكل دفعة</option>
                                    <option value="daily" {{ old('test_frequency') == 'daily' ? 'selected' : '' }}>يومي</option>
                                    <option value="weekly" {{ old('test_frequency') == 'weekly' ? 'selected' : '' }}>أسبوعي</option>
                                    <option value="monthly" {{ old('test_frequency') == 'monthly' ? 'selected' : '' }}>شهري</option>
                                </select>
                        ...
                        <div class="d-flex justify-content-end gap-2">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save me-1"></i>حفظ المعيار
                            </button>
                        </div>
                    </form>
                </div>
