...
@section('content')
    @include('components.breadcrumb', [
        'title' => __('rentals::rentals.edit_building'),
        'breadcrumb_items' => [
            ...
            ['label' => __('rentals::rentals.edit_building')],
        ],
    ])
        ...
        <div class="card shadow-sm">
            <div class="card-header">
                <h5 class="mb-0">
                    ...
                    {{ __('rentals::rentals.edit_building_data') }} <strong class="text-primary">{{ $building->name }}</strong>
                </h5>
            </div>
            <div class="card-body">
                <form action="{{ route('rentals.buildings.update', $building->id) }}" method="POST">
                    ...
                    <div class="card-footer text-end bg-transparent border-top pt-3 pe-0">
                        <button type="submit" class="btn btn-primary">
                            <i class="fas fa-save me-2"></i>{{ __('rentals::rentals.update_building') }}
                        </button>
