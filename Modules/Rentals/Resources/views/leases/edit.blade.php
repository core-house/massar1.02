                    ...
                    <form action="{{ route('rentals.leases.update', $lease->id) }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <x-dynamic-search name="client_id" label="{{ __('Client') }}" column="cname"
                                    model="App\Models\Client" placeholder="{{ __('Search for client...') }}" :required="false"
                                    :class="'form-select'" :selected="$lease->client_id" />
                            </div>
                        ...
                        <div class="card-footer text-end bg-transparent border-top pt-3 pe-0">
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save me-2"></i>{{ __('Update Lease') }}
                            </button>
