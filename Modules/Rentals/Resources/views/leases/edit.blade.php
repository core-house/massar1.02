                    ...
                    <form action="{{ route('rentals.leases.update', $lease->id) }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <x-dynamic-search name="client_id" label="{{ __('rentals::rentals.client') }}" column="aname"
                                    ...
                                    :class="'form-select'" :filters="['acc_type' => 1, 'is_basic' => 0, 'isdeleted' => 0]" :selected="$lease->client_id" />
                            </div>
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <select name="rent_type" class="form-select @error('rent_type') is-invalid @enderror" required>
                                        <option value="daily" @selected(old('rent_type', $lease->rent_type) == 'daily')>{{ __('rentals::rentals.daily') }}</option>
                                        <option value="monthly" @selected(old('rent_type', $lease->rent_type ?? 'monthly') == 'monthly')>{{ __('rentals::rentals.monthly') }}</option>
                                        <option value="yearly" @selected(old('rent_type', $lease->rent_type) == 'yearly')>{{ __('rentals::rentals.yearly') }}</option>
                                    </select>
                                </div>
                                @error('rent_type')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                        ...
                        <div class="card-footer text-end bg-transparent border-top pt-3 pe-0">
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save me-2"></i>{{ __('rentals::rentals.update_lease') }}
                            </button>
