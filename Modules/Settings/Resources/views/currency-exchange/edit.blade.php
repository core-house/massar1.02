...
@section('content')
    @include('components.breadcrumb', [
        'title' => __('settings::settings.edit_currency_exchange'),
        'breadcrumb_items' => [
            ...
            ['label' => __('settings::settings.edit_operation')],
        ],
    ])
            ...
            <form id="currencyExchangeForm" action="{{ route('settings.currency-exchange.update', $exchange->id) }}"
                ...
                <div class="card col-md-10 container">
                    <div class="card-header bg-warning">
                        <h2 class="card-title">{{ __('settings::settings.edit_currency_exchange') }}</h2>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            <div class="col-12">
                                <label class="form-label fw-bold">{{ __('settings::settings.operation_type') }} <span
                                ...
                                <div class="d-flex gap-4">
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="buy">
                                            <i class="las la-shopping-cart text-success"></i> {{ __('settings::settings.buy_currency') }}
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="sell">
                                            <i class="las la-hand-holding-usd text-info"></i> {{ __('settings::settings.sell_currency') }}
                                        </label>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <label>{{ __('settings::settings.bond_number') }}</label>
