...
<div class="row">
    <div class="col-lg-8">
        <div class="card">
            <div class="card-body">
                <h2>{{ __('shipping::shipping.add_new_zone') }}</h2>
                <form action="{{ route('shipping.zones.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="name" name="name"
                            placeholder="{{ __('shipping::shipping.enter_zone_name') }}" value="{{ old('name') }}" required>
                    </div>
                    <div class="mb-3">
                        <label class="form-label" for="code">{{ __('shipping::shipping.code') }}</label>
                        <input type="text" class="form-control" id="code" name="code"
                            placeholder="{{ __('shipping::shipping.enter_zone_code') }}" value="{{ old('code') }}" required>
                    </div>
                    <div class="mb-3">
                        <label class="form-label" for="description">{{ __('shipping::shipping.description') }}</label>
                        <textarea name="description" class="form-control" id="description" rows="3"
                            placeholder="{{ __('shipping::shipping.enter_zone_description') }}">{{ old('description') }}</textarea>
                    </div>
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="base_rate" name="base_rate"
                                placeholder="{{ __('shipping::shipping.enter_base_rate') }}" value="{{ old('base_rate') }}" required>
                        </div>
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="rate_per_kg" name="rate_per_kg"
                                placeholder="{{ __('shipping::shipping.enter_rate_per_kg') }}" value="{{ old('rate_per_kg') }}" required>
                        </div>
                    </div>
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="estimated_days" name="estimated_days"
                            placeholder="{{ __('shipping::shipping.enter_estimated_days') }}" value="{{ old('estimated_days') }}" required>
                    </div>
                    <div class="mb-3">
