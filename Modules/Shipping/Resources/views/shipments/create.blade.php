        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h2>{{ __('shipping::shipping.add_new_shipment') }}</h2>
                </div>
                <div class="card-body">
                            ...
                            <div class="row">
                                <div class="mb-3 col-lg-4">
                                    ...
                                    <input type="text" class="form-control" id="tracking_number" name="tracking_number"
                                        placeholder="{{ __('shipping::shipping.enter_tracking_number') }}" value="{{ old('tracking_number') }}">
                                ...
                                <div class="mb-3 col-lg-4">
                                    <label class="form-label" for="customer_address">{{ __('shipping::shipping.address') }}</label>
                                    <textarea class="form-control" id="customer_address" name="customer_address" placeholder="{{ __('shipping::shipping.address') }}">{{ old('customer_address') }}</textarea>
                                ...
                                <div class="mb-3 col-lg-4">
                                    ...
                                    <input type="number" class="form-control" id="weight" name="weight" step="0.01"
                                        placeholder="{{ __('shipping::shipping.enter_weight') }}" value="{{ old('weight') }}">
                                    @error('weight')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
