                            ...
                            <div class="row">
                                <div class="mb-3 col-lg-4">
                                    ...
                                    <input type="text" class="form-control" id="tracking_number" name="tracking_number"
                                        placeholder="{{ __('ادخل رقم التتبع') }}"
                                ...
                                <div class="mb-3 col-lg-4">
                                    ...
                                    <textarea class="form-control" id="customer_address" name="customer_address" placeholder="{{ __('العنوان الكامل') }}">{{ old('customer_address', $shipment->customer_address) }}</textarea>
                                ...
                                <div class="mb-3 col-lg-4">
                                    ...
                                    <input type="number" class="form-control" id="weight" name="weight" step="0.01"
                                        placeholder="{{ __('ادخل الوزن') }}" value="{{ old('weight', $shipment->weight) }}">
                                    @error('weight')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
