                        ...
                        <div class="row">
                            <div class="mb-3 col-lg-4">
                                ...
                                <input type="text" class="form-control" id="name" name="name"
                                    placeholder="{{ __('ادخل اسم الشركة') }}" value="{{ old('name') }}">
                                @error('name')
                            ...
                            <div class="mb-3 col-lg-4">
                                ...
                                <input type="text" class="form-control" id="phone" name="phone"
                                    placeholder="{{ __('ادخل رقم الهاتف') }}" value="{{ old('phone') }}">
                                @error('phone')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                            <div class="mb-3 col-lg-4">
                                ...
                                <textarea class="form-control" id="address" name="address" placeholder="{{ __('العنوان الكامل') }}">{{ old('address') }}</textarea>
                                @error('address')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                            <div class="mb-3 col-lg-4">
                                ...
                                <input type="number" class="form-control" id="base_rate" name="base_rate" step="0.01"
                                    placeholder="{{ __('ادخل السعر الأساسي') }}" value="{{ old('base_rate') }}">
                                @error('base_rate')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
