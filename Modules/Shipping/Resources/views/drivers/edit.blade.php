        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h2>{{ __('shipping::shipping.edit_driver') }}</h2>
                </div>
                <div class="card-body">
                    @can('edit Drivers')
                            ...
                            <div class="row">
                                <div class="mb-3 col-lg-4">
                                    ...
                                    <input type="text" class="form-control" id="name" name="name"
                                        placeholder="{{ __('shipping::shipping.enter_driver_name') }}" value="{{ old('name', $driver->name) }}">
                                    @error('name')
                                ...
                                <div class="mb-3 col-lg-4">
                                    ...
                                    <input type="text" class="form-control" id="phone" name="phone"
                                        placeholder="{{ __('shipping::shipping.enter_phone_number') }}" value="{{ old('phone', $driver->phone) }}">
                                    @error('phone')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3 col-lg-4">
                                    ...
                                    <input type="text" class="form-control" id="vehicle_type" name="vehicle_type"
                                        placeholder="{{ __('shipping::shipping.enter_vehicle_type') }}"
