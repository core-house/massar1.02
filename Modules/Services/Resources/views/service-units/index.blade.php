        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('services.service-units.create') }}" class="btn btn-primary">
                ...
                <div class="card-body">
                            ...
                            <table class="table table-striped table-hover">
                                ...
                                <tbody>
                                    @foreach($serviceUnits as $serviceUnit)
                                        <tr>
                                            <td>
                                                <span class="badge bg-secondary">{{ $serviceUnit->code }}</span>
                                            </td>
                                            <td>
                                                <strong>{{ $serviceUnit->name }}</strong>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <span class="badge bg-primary">{{ $serviceUnit->services_count ?? 0 }}</span>
                                            </td>
                                            <td>
                                                <small class="text-muted">
                                                    {{ $serviceUnit->created_at->format('Y-m-d H:i') }}
                                                </small>
                                            </td>
                                            <td>
                    ...
                    @else
                        <div class="text-center py-5">
                            ...
                            <h5 class="text-muted">لا توجد وحدات خدمات</h5>
                            <p class="text-muted">ابدأ بإضافة وحدة خدمة جديدة</p>
                            <a href="{{ route('services.service-units.create') }}" class="btn btn-primary">
                                <i class="fas fa-plus me-1"></i>
                                إضافة وحدة خدمة جديدة
                            </a>
