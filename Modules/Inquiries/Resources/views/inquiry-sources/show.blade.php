        ...
        <div class="col-12">
            <div class="card printable-content">
                <div class="card-header bg-primary text-white">
                    <h5 class="mb-0"><i class="fas fa-source"></i> {{ __('Inquiry Source Information') }}</h5>
                </div>
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="form-control-static">{{ $source->parent->name }}</div>
                        </div>
                        @endif
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="form-control-static">{{ $source->children->count() }}</div>
                        </div>
                        @endif
                    </div>
                </div>
