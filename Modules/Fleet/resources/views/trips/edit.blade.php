        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h5>{{ __('fleet::fleet.Edit') }} {{ __('fleet::fleet.Trip') }}</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('fleet.trips.update', $trip->id) }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="vehicle_id" class="form-label">
                                    {{ __('fleet::fleet.Vehicle') }} <span class="text-danger">*</span>
                                </label>
                                <select name="vehicle_id" id="vehicle_id"
                                    class="form-control @error('vehicle_id') is-invalid @enderror" required>
                                    <option value="">{{ __('fleet::fleet.Choose') }} {{ __('fleet::fleet.Vehicle') }}</option>
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="driver_id" class="form-label">
                                    {{ __('fleet::fleet.Driver') }} <span class="text-danger">*</span>
                                </label>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="start_date" class="form-label">
                                    {{ __('fleet::fleet.Start Date') }} <span class="text-danger">*</span>
                                </label>
                                <input type="datetime-local" name="start_date" id="start_date"
                                    class="form-control @error('start_date') is-invalid @enderror"
                                    value="{{ old('start_date', $trip->start_date->format('Y-m-d\TH:i')) }}" required>
                                @error('start_date')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="end_date" class="form-label">{{ __('fleet::fleet.End Date') }}</label>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="start_mileage" class="form-label">
                                    {{ __('fleet::fleet.Start Mileage') }} <span class="text-danger">*</span>
                                </label>
                                <input type="number" step="0.01" name="start_mileage" id="start_mileage"
                                    ...
                                    value="{{ old('start_mileage', $trip->start_mileage) }}" required min="0">
                                @error('start_mileage')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="end_mileage" class="form-label">{{ __('fleet::fleet.End Mileage') }}</label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="purpose" class="form-label">{{ __('fleet::fleet.Purpose') }}</label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-3">
                                <x-branches::branch-select :branches="$branches" :selected="$trip->branch_id" />
                            </div>
                        </div>
