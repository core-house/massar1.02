        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h5>{{ __('fleet::Edit') }} {{ __('fleet::Vehicle') }}</h5>
                </div>
                <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="is_active" id="is_active"
                                    ...
                                    <option value="1" {{ old('is_active', $vehicle->is_active) == '1' ? 'selected' : '' }}>{{ __('fleet::Active') }}</option>
                                    <option value="0" {{ old('is_active', $vehicle->is_active) == '0' ? 'selected' : '' }}>{{ __('fleet::Inactive') }}</option>
                                </select>
                                @error('is_active')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
