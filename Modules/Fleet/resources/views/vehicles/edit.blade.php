        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h5>{{ __('fleet::fleet.Edit') }} {{ __('fleet::fleet.Vehicle') }}</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('fleet.vehicles.update', $vehicle->id) }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="plate_number" class="form-label">
                                    {{ __('fleet::fleet.Plate Number') }} <span class="text-danger">*</span>
                                </label>
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="vehicle_type_id" class="form-label">
                                    {{ __('fleet::fleet.Vehicle Type') }} <span class="text-danger">*</span>
                                </label>
                                <select name="vehicle_type_id" id="vehicle_type_id"
                                    class="form-control @error('vehicle_type_id') is-invalid @enderror" required>
                                    <option value="">{{ __('fleet::fleet.Choose') }} {{ __('fleet::fleet.Vehicle Type') }}</option>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="driver_id" class="form-label">
                                    {{ __('fleet::fleet.Driver') }}
                                </label>
                                <select name="driver_id" id="driver_id"
                                    class="form-control @error('driver_id') is-invalid @enderror">
                                    <option value="">{{ __('fleet::fleet.Choose') }} {{ __('fleet::fleet.Driver') }}</option>
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                <label for="model" class="form-label">{{ __('fleet::fleet.Model') }}</label>
                            ...
                            <div class="col-md-4 mb-3">
                                <label for="year" class="form-label">{{ __('fleet::fleet.Year') }}</label>
                            ...
                            <div class="col-md-4 mb-3">
                                <label for="color" class="form-label">{{ __('fleet::fleet.Color') }}</label>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="chassis_number" class="form-label">{{ __('fleet::fleet.Chassis Number') }}</label>
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="engine_number" class="form-label">{{ __('fleet::fleet.Engine Number') }}</label>
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                <label for="current_mileage" class="form-label">
                                    {{ __('fleet::fleet.Current Mileage') }} <span class="text-danger">*</span>
                                </label>
                            ...
                            <div class="col-md-4 mb-3">
                                <label for="status" class="form-label">
                                    {{ __('fleet::fleet.Status') }} <span class="text-danger">*</span>
                                </label>
                            ...
                            <div class="col-md-4 mb-3">
                                <label for="purchase_date" class="form-label">{{ __('fleet::fleet.Purchase Date') }}</label>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="purchase_cost" class="form-label">{{ __('fleet::fleet.Purchase Cost') }}</label>
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="is_active" class="form-label">{{ __('fleet::fleet.Is Active') }}</label>
                                <select name="is_active" id="is_active"
                                    class="form-control @error('is_active') is-invalid @enderror">
                                    <option value="1" {{ old('is_active', $vehicle->is_active) == '1' ? 'selected' : '' }}>{{ __('fleet::fleet.Active') }}</option>
                                    <option value="0" {{ old('is_active', $vehicle->is_active) == '0' ? 'selected' : '' }}>{{ __('fleet::fleet.Inactive') }}</option>
                                </select>
                                @error('is_active')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="row">
                            <div class="col-md-9 mb-3">
                                <label for="notes" class="form-label">{{ __('fleet::fleet.Notes') }}</label>
                        ...
                        <div class="mt-3">
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save me-2"></i>{{ __('fleet::fleet.Update') }}
                            </button>
                            <a href="{{ route('fleet.vehicles.index') }}" class="btn btn-secondary">
                                <i class="fas fa-arrow-left me-2"></i>{{ __('fleet::fleet.Back') }}
                            </a>
                        </div>
                    </form>
                </div>
