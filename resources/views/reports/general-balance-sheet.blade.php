                                ...
                                <table class="table table-hover table-sm mb-0">
                                    ...
                                    <tbody>
                                        @foreach($assets as $asset)
                                            @include('reports.partials.account-row-recursive', ['account' => $asset, 'level' => 0])
                                        @endforeach
                                    </tbody>
                                ...
                                <table class="table table-hover table-sm mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach($liabilities as $liability)
                                            @include('reports.partials.account-row-recursive', ['account' => $liability, 'level' => 0])
                                        @endforeach
                                        
                                        {{-- حقوق الملكية --}}
                                        @foreach($equity as $eq)
                                            @include('reports.partials.account-row-recursive', ['account' => $eq, 'level' => 0])
                                        @endforeach
