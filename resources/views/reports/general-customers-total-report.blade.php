            ...
            <div class="row mt-3">
                ...
                <div class="col-md-3">
                    <div class="alert alert-success">
                        <strong>أعلى عميل مبيعات:</strong> {{ $topCustomer ?? '---' }}
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="alert alert-warning">
                        <strong>متوسط المبيعات للعميل:</strong> {{ number_format($averageSalesPerCustomer, 2) }}
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="alert alert-primary">
                        <strong>متوسط الرصيد للعميل:</strong> {{ number_format($averageBalancePerCustomer, 2) }}
                    </div>
                </div>
            </div>
        </div>
