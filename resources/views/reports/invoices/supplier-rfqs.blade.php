                            ...
                            <table class="table table-hover mb-0">
                                ...
                                <tbody>
                                    ...
                                    '<span class="badge bg-success" style="font-size: 1.2rem;"><i class="fas fa-medal"></i> 1</span>';
                                        ...
                                        $rowClass='table-info' ;
                                        $statusBadge='<span class="badge bg-info"><i class="fas fa-star"></i> ' .
                                        __('Excellent Price') . '</span>' ;
                                        $rankBadge='<span class="badge bg-info" style="font-size: 1.2rem;">' .
                                        ($index + 1) . '</span>' ;
                                        } elseif ($percentDiff <=10) {
                                        $rowClass='table-warning' ;
                                        $statusBadge='<span class="badge bg-warning"><i class="fas fa-exclamation-triangle"></i> ' .
                                        __('Acceptable Price') . '</span>' ;
                                        $rankBadge='<span class="badge bg-warning" style="font-size: 1.2rem;">' .
                                        ($index + 1) . '</span>' ;
                                        } else {
                                        $rowClass='table-danger' ;
                                        $statusBadge='<span class="badge bg-danger"><i class="fas fa-times-circle"></i> ' .
                                        __('High Price') . '</span>' ;
                                        $rankBadge='<span class="badge bg-danger" style="font-size: 1.2rem;">' .
                                        ($index + 1) . '</span>' ;
                                        }
                                        @endphp
                                        <tr class="{{ $rowClass }}">
