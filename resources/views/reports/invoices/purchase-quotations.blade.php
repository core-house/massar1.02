...
@section('content')
    @include('components.breadcrumb', [
        'title' => __('تقرير عرض سعر لعميل '),
        'items' => [
            ['label' => __('الرئيسيه'), 'url' => route('admin.dashboard')],
            ['label' => __('عرض سعر لعميل')],
        ],
    ])
            ...
            <div class="card">
                <div class="card-body">
                    <div class="table-responsive" style="overflow-x: auto;">
                        ...
                        <x-table-export-actions table-id="purchase-quotation-invoice-report-table"
                            filename="purchase-quotation-invoice-report-table" excel-label="تصدير Excel" pdf-label="تصدير PDF"
                            print-label="طباعة" />

                        <table id="purchase-quotation-invoice-report-table"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if ($invoice->pro_type == 16)
                                                <span class="badge bg-primary">عرض سعر لعميل </span>
                                            @endif
                                        </td>
