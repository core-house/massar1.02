    ...
    <form id="myForm" action="{{ route('transfers.store') }}" method="POST">
        ...
        <div class="card bg-white col-md-11 container">
            <div class="card-header">
                <h1 class="h1 mb-0">{{ $pageTitle ?? __('vouchers.add_transfer') }}</h1>
            </div>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    @if(isMultiCurrencyEnabled())
                        ...
                        <div class="col-lg-3">
                            <div class="form-group">
                                ...
                                <input type="text" id="converted_amount" readonly class="form-control bg-light" placeholder="0.00">
                            </div>
                        </div>
                    @endif
                    ...
                    <div class="col-lg-{{ isMultiCurrencyEnabled() ? '3' : '6' }}">
                        <div class="form-group">
                            ...
                            <input type="text" name="details" class="form-control" placeholder="{{ __('vouchers.enter_description') }}">
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <div class="d-flex align-items-center gap-2">
                                <select name="acc2" id="from_account" class="form-control js-tom-select flex-grow-1">
                                ...
                                @if(isMultiCurrencyEnabled())
                                    <span id="from_account_currency" class="badge bg-info" style="display:none;"></span>
                                @endif
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="form-group">
                            <label>{{ __('vouchers.to_account') }}</label>
                            <div class="d-flex align-items-center gap-2">
                                <select name="acc1" id="to_account" class="form-control js-tom-select flex-grow-1">
                                    <option value="">{{ __('vouchers.select_account') }}</option>
                                ...
                                @if(isMultiCurrencyEnabled())
                                    <span id="to_account_currency" class="badge bg-info" style="display:none;"></span>
                                @endif
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="info" class="form-control" placeholder="{{ __('vouchers.enter_notes') }}">
                        </div>
                    </div>
                </div>
            ...
            <div class="card-footer">
                <button type="submit" class="btn btn-main btn-lg">{{ __('vouchers.save') }}</button>
            </div>
        </div>
    </form>
@endsection
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        function updateCurrencyBadges() {
            ...
            ['from_account', 'to_account'].forEach((id, i) => {
                const el = document.getElementById(id);
                const badge = document.getElementById(i === 0 ? 'from_account_currency' : 'to_account_currency');
                if (!el || !badge) return;
        ...
        function checkAndUpdateCurrency() {
            ...
            const fromId = getAccountCurrencyId(fromEl);
            const toId   = getAccountCurrencyId(toEl);
            if (!fromId || !toId) {
                document.getElementById('currency_id').value = '1';
                document.getElementById('currency_rate').value = '1';
                return true;
            ...
            document.getElementById('currency_id').value = fromId;
            document.getElementById('currency_rate').value = rates[fromId] || 1;
            return true;
        }
