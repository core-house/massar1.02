...
new class extends Component {
    ...
    public function save()
    {
        ...
        try {
            ...
            session()->flash('success', 'تم إنشاء أمر الإنتاج بنجاح');
            return redirect()->route('production-orders.index');
            
        } catch (\Exception $e) {
            DB::rollBack();
            session()->flash('error', 'حدث خطأ أثناء إنشاء أمر الإنتاج: ' . $e->getMessage());
        }
    }
...
<div class="container-fluid">
    ...
    <div class="row mb-4">
        <div class="col-md-6">
            <h2 class="mb-1">إنشاء أمر إنتاج جديد</h2>
            <p class="text-muted">إضافة أمر إنتاج جديد للنظام</p>
        </div>
