...
new class extends Component {
    ...
    {
        return ProductionOrder::with(['customer', 'createdBy', 'productionInvoice'])
...
<div class="container-fluid">
    ...
    <div class="row mb-4">
        ...
        <div class="col-md-1 d-flex align-items-end mb-4">
            <button wire:click="clearFilters" class="btn btn-outline-secondary font-hold fw-bold" title="مسح الفلاتر">
                مسح الفلاتر
            </button>
        </div>
    </div>
                        ...
                        <tbody>
                            @foreach($this->productionOrders as $order)
                                <tr>
                                    ...
                                    <td class="font-hold fw-bold">{{ number_format($order->total_amount, 2) }} ريال</td>
