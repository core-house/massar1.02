...
<div>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
                                ...
                                <tbody>
                                    ...
                                    @forelse ($evaluations as $evaluation)
                                        <tr>
                                            ...
                                            @canany(['تعديل معدلات أداء الموظفين', 'حذف معدلات أداء الموظفين'])
                                                <td>
                            ...
                            <form wire:submit="{{ $showEditModal ? 'update' : 'save' }}">
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" value="{{ $job_title }}"
                                            readonly>
                                    </div>
                                    <div class="col-md-6">
                                        <label class="form-label">{{ __('القسم') }}</label>
                                        <input type="text" class="form-control" value="{{ $department }}"
                                            readonly>
                                    </div>
                                </div>
            ...
            <!-- Add/Edit Evaluation Modal -->
            <div class="modal fade" id="addEvaluationModal" tabindex="-1" wire:ignore.self
                        ...
                        <div class="modal-body">
                            <form wire:submit="{{ $showEditModal ? 'update' : 'save' }}">
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        <label class="form-label">{{ __('فترة التقييم من') }}</label>
                                        <input type="date" wire:model="evaluation_period_from"
                                            class="form-control">
                                        @error('evaluation_period_from')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
