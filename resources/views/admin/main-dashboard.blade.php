...
>
    <head>
        ...
        />
        <link
            href="{{ asset('assets/css/app-rtl.min.css') }}"
            rel="stylesheet"
            type="text/css"
        />
        ...
        <link
            rel="stylesheet"
            href="{{ asset('css/themes/masar-themes.css') }}"
        />
        ...
        <link
            rel="stylesheet"
            href="{{ asset('assets/css/dashboard-main.css') }}"
        />
    ...
    <body class="theme-neumorphism-lite">
        <script>
            (function () {
                ...
                var t =
                    v &&
                    ["classic", "mint-green", "dark", "monokai"].indexOf(v) !==
                        -1
                        ? v
                        : "classic";
        ...
        <div class="doodles-container">
            ...
            >
                <path
                    d="M25 20 L25 65 L60 65 L60 35 L45 35 L45 20 Z"
                    stroke="#239d77"
                    stroke-width="2.5"
                    fill="none"
                    opacity="0.25"
            ...
            >
                <polygon
                    points="47.5,15 70,30 70,55 47.5,70 25,55 25,30"
                    stroke="#2ba88a"
                    stroke-width="2.5"
                    fill="none"
                    opacity="0.25"
        ...
        <div class="topbar">
            ...
            >
                <ul
                    class="list-unstyled topbar-nav mb-0 d-flex align-items-center"
                >
                    ...
                    <li class="dropdown me-3" data-masar-theme-dropdown>
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            <a
                                class="dropdown-item"
                                href="#"
                                data-masar-theme="classic"
                                ><i class="fas fa-palette me-1"></i> Classic
                                (Bootstrap)</a
                            >
                            <a
                                class="dropdown-item"
                                href="#"
                                data-masar-theme="mint-green"
                                ><i class="fas fa-leaf me-1"></i> Mint Green</a
                            >
                            <a
                                class="dropdown-item"
                                href="#"
                                data-masar-theme="dark"
                                ><i class="fas fa-moon me-1"></i> Dark Mode</a
                            >
                            <a
                                class="dropdown-item"
                                href="#"
                                data-masar-theme="monokai"
                                ><i class="fas fa-code me-1"></i> Monokai</a
                            >
                        </div>
                    </li>
                    ...
                    <li>
                        <button
                            type="button"
                            class="btn btn-lg transition-base logout-btn"
                            title="{{ __('navigation.logout') }}"
                ...
                <div class="d-flex align-items-center mx-4">
                    <div class="search-container-navbar">
                        ...
                        <input
                            ...
                            placeholder="{{
                                __('dashboard.search_placeholder')
                            }}"
                        />
                        <span
                            class="search-count-navbar"
                            id="searchCount"
                        ></span>
                    </div>
                </div>
                ...
                <ul
                    class="list-unstyled topbar-nav mb-0 d-flex align-items-center order-first"
                >
                    <li>
                        <a
                            title="help"
                            href="https://www.updates.elhadeerp.com"
                            class="nav-link transition-base"
                            target="_blank"
                            style="color: #34d3a3"
                        >
        ...
        <script>
            function confirmLogout() {
                Swal.fire({
                    ...
                    confirmButtonText:
                        '<i class="fas fa-sign-out-alt"></i> نعم، تسجيل الخروج',
            ...
            <div class="stats-cards-section">
                <div class="row g-3 stats-cards-row">
                    ...
                    <div class="col-lg-4 col-md-4 stats-card-col">
                        <div
                            class="card border-0 shadow-lg h-100 stats-card stats-card-clients"
                        >
                            <div class="card-body">
                                <div
                            ...
                            <div
                                class="card-decoration card-decoration-top"
                            ></div>
                            <div
                                class="card-decoration card-decoration-bottom"
                            ></div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-4 stats-card-col">
                        <div
                            class="card border-0 shadow-lg h-100 stats-card stats-card-logins"
                        >
                            <div class="card-body">
                                <div
                                    class="d-flex justify-content-between align-items-start"
                    ...
                    <div class="col-lg-4 col-md-4 stats-card-col">
                        <div
                            class="card border-0 shadow-lg h-100 stats-card stats-card-sales"
                        >
                            <div class="card-body">
                                <div
                                    class="d-flex justify-content-between align-items-start"
            ...
            <div class="apps-groups-section" id="appsGroupsSection">
                ...
                <div class="module-group" data-group="core">
                    ...
                    <div class="module-group-icons">
                        ...
                        @canany(['view Clients', 'view Suppliers', 'view Funds',
                        'view Banks', 'view Employees', 'view warhouses', 'view
                        Expenses', 'view Revenues', 'view various_creditors',
                        'view various_debtors', 'view partners', 'view
                        current_partners', 'view assets', 'view rentables',
                        'view check-portfolios-incoming', 'view
                        ...
                        @canany(['view items', 'view units', 'view prices',
                        'view notes-names', 'view varibals', 'view
                        varibalsValues'])
                        <a
                        ...
                        @endcan
                        {{-- الصلاحيات --}}
                        @canany(['view roles', 'view branches', 'view settings',
                        'view login-history', 'view active-sessions', 'view
                        activity-logs'])
                        <a
                            href="{{ route('users.index') }}"
                            class="app-icon-large icon-bg-green"
                ...
                <div class="module-group" data-group="sales">
                    ...
                    <div class="module-group-icons">
                        ...
                        <a
                            href="{{ route('invoices.index', ['type' => 10]) }}"
                            class="app-icon-large icon-bg-green"
                            target="_blank"
                        ...
                        <a
                            ...
                            class="app-icon-large icon-bg-green"
                            target="_blank"
                            title="{{ __('dashboard.installments') }}"
                        >
                            <div class="icon-wrapper">
                                <i data-lucide="tag"></i>
                            </div>
                ...
                <div class="module-group" data-group="logistics">
                    <div class="module-group-header module-group-header-green">
                        ...
                        <small>{{
                            __("dashboard.group_logistics_desc")
                        }}</small>
                    </div>
                    <div class="module-group-icons">
                        {{-- المشتريات --}}
                        ...
                        <a
                            href="{{ route('invoices.index', ['type' => 11]) }}"
                            class="app-icon-large icon-bg-green"
                            target="_blank"
                            title="{{ __('dashboard.purchases') }}"
                        >
                            <div class="icon-wrapper">
                        ...
                        {{-- ادارة المخزون --}}
                        @if (tenant()->hasModule('invoices'))
                        @canany(['view Inventory-Management', 'view Damaged
                        Goods Invoice', 'view Dispatch Order', 'view Addition
                        Order', 'view Store-to-Store Transfer'])
                        <a
                            href="{{ route('invoices.index', ['type' => 18]) }}"
                            class="app-icon-large icon-bg-green"
                            target="_blank"
                            title="{{ __('dashboard.inventory') }}"
                        >
                            <div class="icon-wrapper">
                                <i data-lucide="package"></i>
                            </div>
                ...
                <div class="module-group" data-group="finance">
                    ...
                    <div class="module-group-icons">
                        ...
                        @can('view journals')
                        <a
                            href="{{ route('journals.index', ['type' => 'basic_journal']) }}"
                            class="app-icon-large icon-bg-green"
                            target="_blank"
                        ...
                        @can('view Checks')
                        <a
                            href="{{ route('checks.incoming') }}"
                            class="app-icon-large icon-bg-green"
                            style="position: relative"
                            target="_blank"
                            title="{{ __('dashboard.checks') }}"
                        >
                            <span
                                style="
                                    position: absolute;
                        ...
                        @endif
                        {{-- السندات الماليه --}}
                        @canany(['view receipt vouchers', 'view payment
                        vouchers', 'view exp-payment'])
                        <a
                ...
                <div class="module-group" data-group="management">
                    <div class="module-group-header module-group-header-cyan">
                        ...
                        <small>{{
                            __("dashboard.group_management_desc")
                        }}</small>
                    </div>
                    <div class="module-group-icons">
                        {{-- التقارير --}}
                        @canany(['view DailyWorkAnalysis', 'view
                        Chart-of-Accounts', 'view balance-sheet', 'view
                        Profit-Loss', 'view Sales-Reports', 'view
                        Purchasing-Reports', 'view Inventory-Reports', 'view
                        Expenses-Reports'])
                        <a
                            href="{{ route('reports.index') }}"
                            class="app-icon-large icon-bg-green"
                        ...
                        @canany(['view progress-recyclebin','view
                        progress-project-types','view
                        progress-project-templates','view
                        progress-item-statuses','view progress-work-items','view
                        progress-work-item-categories','view
                        daily-progress','view progress-issues','view
                        ...
                        <a
                            ...
                            class="app-icon-large icon-bg-green"
                            target="_blank"
                            title="{{ __('dashboard.daily_progress') }}"
                        >
                            <div class="icon-wrapper">
                        ...
                        <a
                            href="{{ route('mobile.employee-login') }}"
                            class="app-icon-large icon-bg-green"
                            target="_blank"
                            title="{{ __('dashboard.mobile_fingerprint') }}"
                        >
                            <div class="icon-wrapper">
                ...
                <div class="module-group" data-group="operations">
                    <div class="module-group-header module-group-header-pink">
                        ...
                        <small>{{
                            __("dashboard.group_operations_desc")
                        }}</small>
                    </div>
                    <div class="module-group-icons">
                        {{-- التصنيع --}}
                        ...
                        <a
                            href="{{ route('manufacturing.create') }}"
                            class="app-icon-large icon-bg-green"
                            target="_blank"
                            title="{{ __('dashboard.manufacturing') }}"
                        >
                            <div class="icon-wrapper">
                                <i data-lucide="factory"></i>
                            </div>
                        ...
                        @canany(['view quality', 'view inspections', 'view
                        standards', 'view ncr', 'view capa', 'view batches',
                        'view rateSuppliers', 'view certificates', 'view
                        audits'])
                        <a
                        ...
                        @can('view Buildings')
                        <a
                            href="{{ route('rentals.buildings.index') }}"
                            class="app-icon-large icon-bg-green"
                            target="_blank"
                            title="{{ __('dashboard.rentals') }}"
                        >
                            <div class="icon-wrapper">
                        ...
                        @can('view Projects') @if(Route::has('projects.index'))
                        <a
                        ...
                        @canany(['view Service Types', 'view Maintenances',
                        'view Periodic Maintenance', 'view Maintenance'])
                        <a
                            href="{{ route('service.types.index') }}"
                            class="app-icon-large icon-bg-green"
                            target="_blank"
                            title="{{ __('dashboard.maintenance') }}"
                        >
                            <div class="icon-wrapper">
            ...
            <div class="apps-icons-row d-none" id="searchResultsRow">
                <div class="d-flex" id="searchResultsGrid">
                    ...
                    <div class="app-icon-group">
                        ...
                        progress-project-templates','view
                        progress-item-statuses','view progress-work-items','view
                        progress-work-item-categories' ,'view daily-progress',
                        'view progress-issues','view progress-projects','view
                        progress-dashboard'])
                        @if(Route::has('progress.dashboard'))
                        <a
                            href="{{ route('progress.dashboard') }}"
                        ...
                        <div class="card border-0 shadow-sm h-100">
                            ...
                            <div class="card-body">
                                <div class="d-flex flex-column gap-3">
                                    <div
                                        class="sales-stats-item d-flex justify-content-between align-items-center"
                                    >
                                        <span class="sales-stats-label">{{
                                            __("dashboard.last_invoice")
                                        }}</span>
