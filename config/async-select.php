...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Default UI theme for the component. Options: 'bootstrap' or 'tailwind'.
    | You can override this on a per-component basis by passing :ui="bootstrap"
    | or :ui="tailwind".
    |
    */
    ...
    | Bootstrap 5 utility classes with this prefix when using the bootstrap theme.
    |
    */
    'class_prefix' => 'las-',
